...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 4363 or testnet: 14363)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 4364 or testnet: 14364)") + "\n" +
        ...
        "\n" + _("SSL options: (see the VapeCoin Wiki for SSL setup instructions)") + "\n" +
