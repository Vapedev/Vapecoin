...
uint256 hashGenesisBlock("0xb88ae84e500d485a0858b22bbe5cfb65d320eaaaccabd751106144bfe4cf4af7");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb88ae84e500d485a0858b22bbe5cfb65d320eaaaccabd751106144bfe4cf4af7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1435480083, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "28/Jun/2015 july 2015 london Protests";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xea5e588c27237c8a988050b3f67d3c1550dcfc94368f3978865abf944e3db2f0"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // VapeCoin: increase each by adding 2 to bitcoin's value.
...
void static VapeCoinMiner(CWallet *pwallet)
{
    printf("VapeCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running VapeCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&VapeCoinMiner, pwallet));
}
